...
STAT_CHECKS: tuple[StatCheck, ...] = (
    ...
    StatCheck(
        ...
        rubric=(
            ...
            "documented? FAIL if the claimed population implies a representative or "
            "probability sample but the code/data indicates convenience sampling or "
            "undocumented exclusions. Mark unverified if neither the population nor "
            "the sampling procedure can be established."
        ),
    ),
    StatCheck(
