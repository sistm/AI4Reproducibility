...
TOOLS: dict[str, dict[str, Any]] = {
    ...
    "run_static_check": {
        ...
        "description": "Run a single CQV static check against an extracted repository.",
        "args": {
            "tool_id":   "Name of the static check (see list_static_checks).",
            "repo_path": "Path to the extracted repository.",
        },
    },
    "list_static_checks": {
        "function": list_static_checks,
